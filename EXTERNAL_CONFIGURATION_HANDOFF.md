...
| `RESEND_API_KEY` / `RESEND_FROM_EMAIL` | Resend | Transactional email fallback | Production | Edge secrets | n/a | Mail send | Send test | Password reset email (Auth SMTP is separate) | Email disabled if Hostinger also unset | Console | Ops |
