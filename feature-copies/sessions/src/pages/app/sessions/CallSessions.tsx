    ...
    <div className="relative overflow-hidden border-b border-border last:border-b-0">
      ...
      <div
        ...
        onClick={(e) => {
          ...
          // #region agent log
          fetch('http://127.0.0.1:7572/ingest/ea82b87b-41ef-4cec-a41d-f9c122e76fc2',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'fcd48a'},body:JSON.stringify({sessionId:'fcd48a',runId:'post-fix',hypothesisId:'SES-ROW',location:'CallSessions.tsx:rowClick',message:'session row navigate',data:{sessionId:s.id},timestamp:Date.now()})}).catch(()=>{});
          // #endregion
