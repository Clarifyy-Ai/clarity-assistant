...
def credits_cases() -> list[dict]:
    return [
        ...
        tc("TC-CR-005", "Credits", "Boundary — exact remaining credits",
           "1. With known small balance, run action costing exactly remaining (if known from UI).\n2. Confirm success then subsequent block.",
           "1. Exact spend succeeds if allowed.\n2. Next action blocks at zero.",
           "Exact credit boundary behaves correctly.",
           priority="P1", severity="Major", test_type="Boundary", account="LOW_CREDIT_01"),
