...
function showBootError(error: unknown): void {
  ...
  const description = isMissingEnv
    ? "This deployment is missing required configuration. The site owner needs to set the public environment values in the hosting dashboard and trigger a full rebuild — this is not an issue with your device or network."
    : "The app hit an unexpected error while starting up. Try reloading the page; if this keeps happening, please contact support.";
