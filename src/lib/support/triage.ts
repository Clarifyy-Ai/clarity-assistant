/** Live Chat triage: priority, auto-escalation, and user-facing incident copy. */

import type { SupportCategory, SupportIntent } from "@/lib/support/classify";
...
export function compareSupportPriority(a: SupportPriority, b: SupportPriority): number {
...
export function waitingStatusLabel(priority: SupportPriority | null | undefined): string {
  switch (priority) {
    case "urgent":
      return "Urgent — agent assigned soon";
    case "high":
      return "Priority — waiting for agent";
    case "low":
      return "Queued — agent will reply when available";
    default:
