...
export const AI_MESSAGES = {
  ...
  BYOK_INVALID:             "Bring-your-own API keys are not supported. Career Pilot uses server-managed AI credentials.",
  BYOK_SAVED:               "Bring-your-own API keys are not supported.",
