...
export const LEGAL_PROSE_CLASS = [
  "legal-prose prose prose-sm dark:prose-invert max-w-none !text-left",
  ...
  "prose-li:text-sm prose-li:leading-relaxed prose-li:text-muted-foreground prose-li:!text-left",
