...
export const PLAN_DEFINITIONS: Record<UserPlan, PlanFeatures> = {
  ...
  team: {
    ...
    highlighted_features: ["5 seats", "150 credits/mo", "Practice rooms"],
    ai_models: ["Gemini Flash", "Gemini Pro", "GPT-4o", "Claude"],
    is_popular: false,
    cta_label: "Start Team — $25/mo",
    stripe_price_monthly: null,
    stripe_price_annual: null,
  },
  enterprise: {
    ...
    highlighted_features: ["Unlimited credits", "SSO", "SLA"],
    ai_models: ["All models + custom"],
    is_popular: false,
