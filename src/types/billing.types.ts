...
export const PLAN_DEFINITIONS: Record<UserPlan, PlanFeatures> = {
  free: {
    ...
    seat_count: 1,
    features: [
      "50 credits at signup (one-time balance)",
      "Gemini Flash model",
      "Basic mock sessions",
      "Prep lab (limited)",
    ...
    highlighted_features: ["50 credits at signup", "Gemini Flash"],
  ...
  pro: {
    ...
    price_annual_usd: 99,
    credits_monthly: 1400,
    seat_count: 1,
    features: [
      "1,400 credits (one-time purchase)",
      "All 4 AI models",
    ...
    highlighted_features: ["1,400 credits", "All 4 AI models", "Full analytics"],
    ai_models: ["Gemini Flash", "Gemini Pro", "GPT-4o", "Claude"],
    is_popular: true,
    cta_label: "Start Pro — ₹2,499",
