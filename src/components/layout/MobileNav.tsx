...
// ─────────────────────────────────────────────────────────────────
// MobileNav
// Bottom tab bar shown on mobile (<768px) only.
// ─────────────────────────────────────────────────────────────────
...
export function MobileNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 bg-[#0d0d14]/95 backdrop-blur border-t border-white/8 z-40 flex items-center md:hidden">
      {TABS.map((tab) => (
        <NavLink
          key={tab.to}
          to={tab.to}
