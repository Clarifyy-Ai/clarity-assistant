...
export function OverlayChatInput({ onSubmit }: OverlayChatInputProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        "flex-1 flex items-center gap-2 rounded-xl px-3 py-1.5 transition-all duration-200",
      ...
      <button
        ...
        className={cn(
          ...
          canSubmit
            ? "bg-indigo-600/30 border border-indigo-500/30 text-indigo-300 hover:bg-indigo-600/45 hover:text-indigo-200 shadow-sm"
