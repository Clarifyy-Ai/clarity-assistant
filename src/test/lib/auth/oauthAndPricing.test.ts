...
describe("pricing exact 20% savings", () => {
  it("PLANS pro/enterprise yearly equal monthly×12×0.8", () => {
...
describe("isOAuthCancelledError", () => {
  ...
  it("treats description text containing cancelled / access_denied as cancelled", () => {
  ...
  it("does not treat unrelated auth failures as cancelled", () => {
