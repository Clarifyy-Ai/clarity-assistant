...
describe("interviewReminderWorkerCheck", () => {
  it("is NOT_CONFIGURED when Resend is absent", () => {
    ...
    expect(check.detail).toMatch(/Resend/);
  });

  it("is WARNING when Resend is present because Vault is not verified from git", () => {
