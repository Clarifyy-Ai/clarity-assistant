    ...
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="space-y-4">
          <Card>
            <p className="text-xs font-semibold text-gray-300 uppercase tracking-widest mb-3">Project Details</p>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-black/30 border border-white/10 text-white placeholder-gray-600 rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-violet-500"
                  />
                    ...
                    {techStack.map((t) => (
                      <Badge key={t} variant="default" size="sm" className="pr-1">
                        ...
                        <button
                          ...
                          className="ml-1.5 text-gray-500 hover:text-white"
                        >
          ...
          <Card>
            <p className="text-xs font-semibold text-gray-300 uppercase tracking-widest mb-3">What you did</p>
            <textarea
              value={description}
          ...
          <Card>
            <p className="text-xs font-semibold text-gray-300 uppercase tracking-widest mb-3">Impact & Metrics (optional)</p>
            <textarea
              value={impact}
        ...
        <div className="space-y-4">
          ...
          {showcase ? (
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={cn(
                      "transition-colors",
                      saved ? "text-emerald-400" : "text-gray-500 hover:text-gray-300"
                    )}
                  >
            ...
            <Card className="text-center py-16">
              ...
              <p className="text-gray-400 text-sm">Your polished project showcase will appear here</p>
