...
const ARTICLES: Article[] = [
  ...
  { id: "bi-4", q: "Do unused credits roll over?", categorySlug: "billing", a: "**Monthly plan credits** reset at the start of each billing cycle and do not roll over.\n\n**Purchased credit packs** do not expire and carry forward indefinitely until used.", category: "Billing & Credits", related: ["bi-1", "bi-2"] },
