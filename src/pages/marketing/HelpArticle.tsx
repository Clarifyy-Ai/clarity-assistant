...
const ARTICLES: Article[] = [
  ...
  { id: "bi-2", q: "How much do paid plans cost?", categorySlug: "billing", a: "Pro is **$29 / month** for 2,000 credits and unlocks the full feature set. Enterprise is **$79 / month** per seat with unlimited credits and team controls. Yearly billing saves roughly two months. Upgrade anytime from **Settings → Billing**.", category: "Billing & Credits", related: ["bi-1", "bi-3"] },
  { id: "bi-5", q: "Can I buy extra credits?", categorySlug: "billing", a: "À la carte credit packs are not available at launch. To increase your monthly allowance, upgrade to **Pro** (2,000 credits/month) or **Enterprise** (unlimited credits) from **Settings → Billing**.", category: "Billing & Credits", related: ["bi-1", "bi-2"] },
...
const CATEGORY_SLUGS: Record<string, { title: string; ids: string[] }> = {
  ...
  "billing":         { title: "Billing & Credits", ids: ["bi-1", "bi-2", "bi-3", "bi-4", "bi-5"] },
