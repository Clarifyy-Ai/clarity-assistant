    ...
    <div className="min-h-screen bg-[#07070d] text-white overflow-x-hidden">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-2xl mx-auto">
          <Link to="/blog" className="inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-white transition-colors mb-6">
          ...
          <div className="mt-12 pt-8 border-t border-white/[0.06] text-center">
            ...
            <p className="text-sm text-gray-400 mb-4">Get your first 5 mock sessions free. No credit card required.</p>
            <Link
              to="/signup"
