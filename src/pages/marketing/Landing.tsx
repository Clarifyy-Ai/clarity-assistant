    ...
    <MarketingLayout>
      ...
      <section className="pt-4 sm:pt-8 pb-10 px-4 sm:px-6 text-center">
        ...
        >
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight leading-[1.08] text-balance">
            {PRODUCT_NAMES.tagline}
          </h1>
          <p className="mt-5 text-sm md:text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed text-pretty">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center gap-3 mt-8">
            <Link
              to="/signup"
              className="inline-flex items-center justify-center gap-2 text-sm font-semibold px-5 py-2.5 rounded-xl bg-primary text-primary-foreground hover:opacity-90 transition-opacity shadow-lg shadow-primary/25 min-h-11 w-full sm:w-auto"
            >
              {PUBLIC_CTAS.signup}
            ...
            <Link
              to="/#features"
              className="inline-flex items-center justify-center gap-2 text-sm font-medium px-5 py-2.5 rounded-xl border border-border text-foreground hover:bg-secondary/60 transition-all min-h-11 w-full sm:w-auto"
            >
      ...
      <section id="gov-exams" className="px-4 sm:px-6 bg-amber-500/5 border-y border-amber-500/10">
        <div className={`${MARKETING_SHELL} py-8 sm:py-10`}>
          <m.div className="text-center mb-5" {...fadeUp()}>
            ...
            <p className="mt-3 text-sm text-muted-foreground max-w-xl mx-auto leading-relaxed text-pretty">
      ...
      <section className="pb-14 px-4 sm:px-6 bg-secondary/20">
        <div className="max-w-4xl mx-auto py-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 pt-4 overflow-visible">
