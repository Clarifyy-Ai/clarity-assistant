...
_CAPABILITIES: dict[str, dict[str, Any]] = {
    ...
    "session_scorecard": {
        ...
        "requires_ai": False,
        "category": "analytics",
        "inputs": ["answered", "total", "clarity_score", "structure_score"],
    },
    "analyze_test": {
        "engine": "python_template",
        "requires_ai": False,
        "category": "analytics",
        "inputs": ["correct", "total", "weak_topics", "score_percent"],
    },
    "speech_process": {
        "engine": "speech",
        "requires_ai": False,
        "category": "transcript",
        "inputs": ["transcript", "text", "segments"],
    },
    "prep_rephrase": {
        "engine": "python_template",
        "requires_ai": False,
